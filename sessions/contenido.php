...
<body>
	...
	<div id="contenedor">
		...
		<div id="contenido">
			<?php
			//I do not know which way is better, if checking with isset or declaring a login = off in some way
				if (isset($_SESSION["login"]) && $_SESSION["login"] == true){
						echo "<h1>Texto del contenido principal para usuarios</h1>";
